...
const projects: Project[] = [
    {
        ...
        stacks: ['laravel', 'alpinejs', 'bootstrap'] as Brand[],
        buttons: [
            {
                text: 'Source Code',
                Icon: GitHubIcon,
    ...
    },
    {
        ...
        stacks: ['react', 'material-ui'] as Brand[],
        buttons: [
            {
                text: 'Source Code',
                Icon: GitHubIcon,
    ...
    },
    {
        ...
        stacks: ['hyperledger', 'docker'] as Brand[],
        buttons: [
            {
                text: 'Source Code',
                Icon: GitHubIcon,
    ...
    },
    {
        ...
        stacks: ['react', 'material-ui', 'typescript'] as Brand[],
        buttons: [
            {
                text: 'Source Code',
                Icon: GitHubIcon,
...

    {
        ...
        stacks: ['nextjs', 'hero-ui'] as Brand[],
        buttons: [
            {
                text: 'Source Code',
                Icon: GitHubIcon,
...

    {
        ...
        stacks: ['remix', 'material-ui'] as Brand[],
        buttons: [
            {
                text: 'Visit',
                Icon: WebIcon,
