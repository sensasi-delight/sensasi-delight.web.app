...
const writings: Writing[] = [
    {
        ...
        title: {
            ...
            ja: '食鳥処理場向けハラル認証ブロックチェーンアプリケーション',
        },
        type: 'paper',
        date: '2021-06-17',
        ...
        previewText: {
            ...
            ja: 'インドネシアで取引される製品の大半はハラル認証を取得する必要があります。これは、インドネシアの消費者がハラル認証機関の発行する証明書に大きく依存していることを意味します。ハラル認証は個々の製品を検証するもので、4年後に有効期限が切れるため更新が必要です。',
        },
    },

    {
        ...
        previewText: {
            ...
            ja: 'NoSQL（Not only SQLまたはNon SQL Database）は、非リレーショナルデータベースを指す用語です。本書では、NoSQLデータベースの4種類（キーバリュー、ドキュメント、カラムファミリー、グラフ）を解説しています。さらに、実際の使用事例を通じてこれらのデータベースの活用方法を紹介しています。',
        },
    },

    {
        ...
        previewText: {
            ...
            ja: '私は観察し、気づいたことですが、現在でも多くのプログラマーがGitHubの無料機能を活用していません。これは、私自身がまだGitやGitHubを使ったコード管理に不慣れだった頃を思い出させます。',
        },
    },

    {
        ...
        previewText: {
            ...
            ja: 'Laravelを無料でホスティングする必要性は、ポートフォリオやデモプロダクトアプリケーションを作成するために必要です。',
        },
    },
]
