...
export default [
	{
		...
		previewText: 'Sebagai developer (Laravel) freelance atau pemula, seringkali kita memerlukan web hosting yang gratis untuk meng-”online”-kan aplikasi yang telah dibangun untuk keperluan portofolio atau demonstrasi produk aplikasi kita.'
	}, {
		...
		previewText: 'Ketika membangun aplikasi web yang menggunakan JavaScript, tentu saja kita sangat terbantu oleh komunitas JavaScript di seluruh dunia yang membuat pustaka (library) yang bersifat open-source dan dapat kita gunakan secara cuma-cuma, seperti JQuery, Moment.js, AOS, dan lain-lain.'
	}, {
		...
		previewText: 'NoSQL atau Not only SQL atau Non SQL Database adalah istilahyang digunakan untuk jenis database yang tidak berbentuk. Buku ini menjelaskan empat tipe database NoSQL (Key Value, Document, Column-Family dan Graph). Selain itu, buku ini juga menjelaskan studi kasus penggunaan database tersebut.'
	}
]